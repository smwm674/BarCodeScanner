# BarCodeScanner
Barcode Reader and qr code scanner is extremely easy to use; simply point to qr image or qr scanner you want to scan and app will automatically detect and scan it. No need to press any buttons, take photos or adjust zoom.
...
- barcode reader detects qr code
- Generate encrypted qr /Barcode
- Secure your qr/Barcode with password
- Use as barcode scanner
- Use as qr code scanner
- Use as image scanner
- barcode scanner
- Use as barcode generator
- barcode generator
